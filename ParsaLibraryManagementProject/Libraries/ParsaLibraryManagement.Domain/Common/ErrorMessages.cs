...
public static class ErrorMessages
{
    ...
    public const string NotValidMsg = "The {0} is not valid.";
    public const string ExistMsg = "The {0} exists in the database.";
    public const string DoesNotExistMsg = "The {0} does not exist in the database.";
    public const string DuplicatedValueMsg = "The {0} cannot be duplicated.";
