...
namespace ParsaLibraryManagement.Infrastructure.Migrations
{
    ...
    [Migration("20240117104811_CorrectNavigationProperties2_Migration")]
    partial class CorrectNavigationProperties2_Migration
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("ParsaLibraryManagement.Domain.Entities.BookCategory", b =>
                {
                    ...
                    b.Property<short?>("RefCategoryId")
                        .HasColumnType("smallint");
            ...
            modelBuilder.Entity("ParsaLibraryManagement.Domain.Entities.BookCategory", b =>
                {
                    ...
                    b.HasOne("ParsaLibraryManagement.Domain.Entities.BookCategory", null)
                        .WithMany()
                        .HasForeignKey("RefId")
