...
public interface IBooksServices
{
    ...
    /// </summary>
    /// <param name="command">The data for the new book.</param>
    ...
    Task<string?> AddBookAsync(BookDto command, IFormFile imageFile, string folderName);

    /// <summary>
    /// Updates a book asynchronously.
    /// </summary>
    /// <param name="command">The data for updating the book.</param>
    ...
    /// <returns>A task representing the asynchronous operation, yielding a nullable string representing the result message.</returns>
    Task<string?> UpdateBookAsync(BookDto command, IFormFile? imageFile, string? folderName);
